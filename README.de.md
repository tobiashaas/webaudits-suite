...
| **LocalBusiness-Schema** | Optionales CPT-getriebenes `LocalBusiness`-JSON-LD (Multi-Standort) auf einer gewählten Seite. Aus lassen, wenn das SEO-Plugin die Schemas besitzt. |
